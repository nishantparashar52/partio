      ...
      <div className="min-h-screen bg-hero-radial">
        <nav className="sticky top-0 z-20 border-b bg-white/80 backdrop-blur-md dark:bg-neutral-950/70">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
            <Link to="/home" className="font-display text-2xl font-extrabold text-brand-700 dark:text-brand-400">
              PartyFindr
            </Link>
        ...
        <main className="mx-auto max-w-6xl px-4 py-6">
          <Routes>
            ...
            <Route path="/" element={user ? <Navigate to="/home" /> : <PhoneNumberScreen />} />
